                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="service-bx">
                        ...
                        <div class="info-bx text-center">
                            ...
                            <h4><a href="#">Staff Chat & following</a></h4>
                            <a href="{{route('users.staff')}}" class="btn radius-xl">Start</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="service-bx">
                        ...
                        <div class="info-bx text-center">
                            ...
                            <h4><a href="">Chat Groups  Projects</a></h4>
                            <a href="#" class="btn radius-xl">Start Chat</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="service-bx m-b0">
                        ...
                        <div class="info-bx text-center">
                            ...
                            <h4><a href="#">MY  Library & Exams</a></h4>
                                    ...
                                    <div class="clearfix">
                                        <ul id="masonry" class="ttr-gallery-listing magnific-image row">
                                            ...
                                            <li class="action-card col-xl-4 col-lg-6 col-md-12 col-sm-6 publish">
                                                <div class="cours-bx">
                                                    <div class="action-box">
                                                        <img src="{{asset('assets/images/courses/pic5.jpg')}}" alt="">
                                                        <a href="#" class="btn">Read More</a>
                                                    </div>
                                                    <div class="info-bx text-center">
                                                        <h5><a href="#">Introduction EduChamp – LMS plugin</a></h5>
                                            ...
                                            <li class="action-card col-xl-4 col-lg-6 col-md-12 col-sm-6 publish">
                                                <div class="cours-bx">
                                                    <div class="action-box">
                                                        <img src="{{asset('assets/images/courses/pic7.jpg')}}" alt="">
                                                        <a href="#" class="btn">Read More</a>
                                                    </div>
                                                    <div class="info-bx text-center">
                                                        <h5><a href="#">Introduction EduChamp – LMS plugin</a></h5>
                                            ...
                                            <li class="action-card col-xl-4 col-lg-6 col-md-12 col-sm-6 book">
                                                <div class="cours-bx">
                                                    <div class="action-box">
                                                        <img src="{{asset('assets/images/courses/pic8.jpg')}}" alt="">
                                                        <a href="#" class="btn">Read More</a>
                                                    </div>
                                                    <div class="info-bx text-center">
                                                        <h5><a href="#">Introduction EduChamp – LMS plugin</a></h5>
                                            ...
                                            <li class="action-card col-xl-4 col-lg-6 col-md-12 col-sm-6 publish">
                                                <div class="cours-bx">
                                                    <div class="action-box">
                                                        <img src="{{asset('assets/images/courses/pic9.jpg')}}" alt="">
                                                        <a href="#" class="btn">Read More</a>
                                                    </div>
                                                    <div class="info-bx text-center">
                                                        <h5><a href="#">Introduction EduChamp – LMS plugin</a></h5>
