    ...
    <nav class="ttr-sidebar-nav-chat">
        <div class="toolbar" id="toolbar">
            <div class="toptoolbar">
                <div class="AppTitel">
                    <ul class="AppActionlist">
                        <li id="back" style="display: none">
                            <a id="users_back" style="float: left">
        ...
        <div class="ttr-sidebar-wrapper content-scroll">
            <div id="chat" class="styleShow">
                <div class="_chat set_chat" >
                    <div tabindex="-1" data-tab="3">
                        <div class="">
                            <div class="chat chat_top" style="height: 1152px;">
                                <div id="startchat" class="chat_" style="transition: none 0s ease 0s; height: 65px; transform: translateY(0px);">

                                </div>
                            </div>
                        </div>
                    </div>
                    <a href="#" id="chat_float" class="float">
                        <i class="fa fa-users my-float"></i>
                    </a>
                </div>
        ...
        <!-- sidebar menu end -->
        <div class="_chat set_chat" id="chatUsersId" style="display: none">
            <div tabindex="-1" data-tab="3">
                <div class="">
                    <div class="chat chat_top" style="height: 1152px;">
                        <div  id="lsit_users" class="chat_" style="transition: none 0s ease 0s; height: 65px; transform: translateY(0px);">
                            <div tabindex="-1">
                                <?php if ($users): ?>
                                                    ...
                                                    <div class="user_message">
                                                        <div class="user_message_text">
                                                            <span class="user_message_text_flex"‬>
                                                                ...
                                                                <span id="chat_message" class="_user_text_name _user_text_name_dispaly _user_text_name_visiable _message_text_display">Student Fourth Year</span>
                                                            </span>
                                                        </div>
